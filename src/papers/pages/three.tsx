            ...
            <div className={styles.content}>
              ...
              <div className={styles.papers}>
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/papers/2")}>Previous Page</button>
                    <div>
                    ...
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/papers/4")}>Next Page</button>
                </div>
...
export default PapersPageThree;