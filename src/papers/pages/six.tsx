    ...
    <>
      ...
      <div className={styles.content}>
        ...
        <div style={{ display: 'flex' }} className={styles['pages']}>
          <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/papers/5")}>{t('publications.previous')}</button>
          <div>
            {[...Array(8)].map((_, i) => (
              <button
                key={i}
          ...
          <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/papers/7")}>
            {t('publications.next')}
          </button>
        </div>
      </div>
