            ...
            <div className={styles.content}>
              ...
              <div className={styles.papers}>
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/papers/7")}>Previous Page</button>
                    <div>
...
export default PapersPageEight;