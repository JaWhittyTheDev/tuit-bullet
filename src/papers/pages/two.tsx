            ...
            <div className={styles.content}>
              ...
              <div className={styles.papers}>
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/papers/1")}>Previous Page</button>
                    <div>
                    ...
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/papers/3")}>Next Page</button>
                </div>
