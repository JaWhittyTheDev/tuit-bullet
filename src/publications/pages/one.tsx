        ...
        <>
            ...
            <div className="content" style={{display: 'flex', flexDirection: 'column'}}>
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button disabled className={styles['pages-button-nextprevious']}>Previous Page</button>
                    <div>
                    ...
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/2")}>Next Page</button>
                </div>
            </div>
