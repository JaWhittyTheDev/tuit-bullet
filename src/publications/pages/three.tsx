...
function PublicationsPageThree() {
    useEffect(() => {
        ...
        <>
            ...
            <div className="content">
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/2")}>Previous Page</button>
                    <div>
                    ...
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/4")}>Next Page</button>
                </div>
            </div>
...
export default PublicationsPageThree;