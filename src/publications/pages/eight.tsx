...
function PublicationsPageEight() {
    useEffect(() => {
        ...
        <>
            ...
            <div className="content">
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/7")}>Previous Page</button>
                    <div>
                    ...
                    <button disabled className={styles['pages-button-nextprevious']}>Next Page</button>
                </div>
            </div>
...
export default PublicationsPageEight;