...
function PublicationsPageSeven() {
    useEffect(() => {
        ...
        <>
            ...
            <div className="content">
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/6")}>Previous Page</button>
                    <div>
                    ...
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/8")}>Next Page</button>
                </div>
            </div>
...
export default PublicationsPageSeven;