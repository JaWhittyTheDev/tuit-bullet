        ...
        <>
            ...
            <div className="content">
                ...
                <div style={{display: 'flex'}} className={styles['pages']}>
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/1")}>Previous Page</button>
                    <div>
                    ...
                    <button className={styles['pages-button-nextprevious']} onClick={() => ChangePage("/publications/3")}>Next Page</button>
                </div>
            </div>
...
export default PublicationsPageTwo;